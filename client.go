...
// interacting with the dinari API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (DINARI_API_KEY, DINARI_SECRET,
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("DINARI_SECRET"); ok {
		defaults = append(defaults, option.WithSecret(o))
	}
	return defaults
}

// NewClient generates a new client with the default option read from the
// environment (DINARI_API_KEY, DINARI_SECRET, DINARI_BASE_URL). The option passed
